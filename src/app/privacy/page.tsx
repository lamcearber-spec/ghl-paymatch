...
export default function PrivacyPage() {
  return (
    <InfoPage eyebrow="PayMatch" title="Privacy Policy">
      <p>
        PayMatch is a read-only HighLevel Marketplace app for reconciling invoices, payment transactions, and
        subscriptions. The app requests only read scopes needed to produce month-end discrepancy reports.
      </p>
      <p>
      ...
      <p>
        ...
        amounts, currencies, and payment statuses. PayMatch does not write to HighLevel invoices, payments, contacts,
